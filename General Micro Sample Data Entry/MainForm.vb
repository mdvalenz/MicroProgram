Public Class MainForm
    ...
    Private Sub enterProjectNumbersSDEButton_Click(sender As Object, e As EventArgs) Handles importSamplesSDEButton.Click
    ...
    Private Sub coliformConfirmationsSDEButton_Click(sender As Object, e As EventArgs) Handles coliformConfirmationsSDEButton.Click
        sampleSelectionForm.ShowDialog()
    End Sub

    Private Sub fecalColiformsSDEButton_Click(sender As Object, e As EventArgs) Handles fecalColiformsSDEButton.Click
        sampleSelectionForm.ShowDialog()
    End Sub

    Private Sub ecoliColiformsSDEButton_Click(sender As Object, e As EventArgs) Handles ecoliColiformsSDEButton.Click
        sampleSelectionForm.ShowDialog()
    End Sub
